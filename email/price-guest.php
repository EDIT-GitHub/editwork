                                            ...
                                            <tr>
                                                ...
                                                <td width="560" style="text-align: left; padding-top: 40px; padding-bottom: 80px;">
                                                    ...
                                                    <p style="width: 560px; margin: 1em 0; font-family: "Lucida Sans",Verdana,Arial,sans-serif; font-size: 14px;color:#333;">
                                                        Obrigado pelo teu interesse na EDIT.WORK.
                                                    </p>
                                                    <p style="width: 560px; margin: 1em 0; font-family: "Lucida Sans",Verdana,Arial,sans-serif; font-size: 14px; color:#333;">
                                                       O EDIT.WORK é um workspace pensado para proporcionar um ambiente que impulsione o crescimento de freelancers, Start-ups e empreendedores. Fundado sobre um conceito ligado à educação e desenvolvimento, garantirá a realização de eventos ligados a áreas-chave para o desenvolvimento e crescimento das empresas, através de growth sessions subordinadas aos temas de desenvolvimento de negócio, finanças e outros. Os membros EDIT.WORK poderão frequentar, mensalmente, um workshop da EDIT. que vá ao encontro das suas necessidades, enquanto profissionais.
                                                    </p>
                                                      <p style="width: 560px; margin: 1em 0; font-family: "Lucida Sans",Verdana,Arial,sans-serif; font-size: 14px; color:#333;">
                                                      No que diz respeito ao espaço, os membros do EDIT.WORK poderão ainda usufruir dos espaços comuns do edifício e terão acesso a um auditório com capacidade para 220 pessoas para organização de eventos.
                                                    </p>
                                                      <p style="width: 560px; margin: 1em 0; font-family: "Lucida Sans",Verdana,Arial,sans-serif; font-size: 14px; color:#333;">
                                                     Em breve receberás mais informação sobre a EDIT.WORK. Se entretanto tiveres alguma dúvida, contacta-nos através de <a href="mailto:info@edit.work"> info@edit.work</a>.
